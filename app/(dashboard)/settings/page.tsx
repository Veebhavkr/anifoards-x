...
export default function SettingsPage() {
  ...
  async function changeMemberRole(
    ...
    if (currentRole !== "owner") {
      setError("Only the organization owner can change member roles.");
      return;
    }
    ...
    <DashboardShell>
      <div className="mx-auto max-w-6xl space-y-6 p-4 sm:p-6 lg:p-8">
                      ...
                      <td className="px-3 py-3">
                        ...
                        String(member.role || "").toLowerCase() !== "owner" ? (
                          <select
                            ...
                            disabled={saving}
                            className="rounded-lg border border-gray-300 bg-white px-2.5 py-1.5 text-xs font-semibold capitalize text-gray-700 outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-100 disabled:cursor-not-allowed disabled:opacity-60"
                          >
        ...
        <section className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm sm:p-6">
          ...
          <p className="mt-4 text-xs text-gray-500">Only the organization owner can change member roles. Role changes are protected by a database-level security function.</p>
        </section>
